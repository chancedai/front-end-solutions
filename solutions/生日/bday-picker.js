...
(function( $ ){
  ...
  $.fn.birthdaypicker = function( options ) {
    ...
    return this.each(function() {
      ...
      var palceholders = lang.palceholders;
      ...
      // Add the option palceholders if specified
      if (settings["placeholder"]) {
        $("<option value='0'>"+palceholders.year+"</option>").appendTo($year);
        $("<option value='0'>"+palceholders.month+"</option>").appendTo($month);
        $("<option value='0'>"+palceholders.day+"</option>").appendTo($day);
      }
      ...
      for (var j=0; j<12; j++) { $("<option></option>").attr("value", j+1).text(months[j]).appendTo($month); }
      ...
      $fieldset.change(function() {
        ...
        if (selectedYear != startYear && curMaxMonth != 12) {
          while (curMaxMonth < 12) {
            $month.append("<option value=" + (curMaxMonth+1) + ">" + months[curMaxMonth] + "</option>");
            curMaxMonth++;
          }
        }
