            ...
            bindEvent:function(){
                ...
                wrap.on('touchmove',function(event){
                    ...
                    if (self.iPadStatus == 'ok') {
                        if (self.iPadScrollY == exports.pageYOffset && self.iPadScrollX == exports.pageXOffset && Math.abs(cX) > 5) { //横向触摸
                            self.iPadStatus = 'touch';
                        } else if (self.iPadScrollX == exports.pageXOffset && self.iPadScrollY == exports.pageYOffset && Math.abs(cY) > 5) {
                            self.iPadStatus = 'touch';
                        } else {
                            return;
                        };
